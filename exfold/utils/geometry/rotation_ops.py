...
from exfold.utils.geometry import utils
...
class Rot3Array:
    ...
    def __matmul__(self, other: Rot3Array) -> Rot3Array:
        ...
        c0 = self.apply_to_point(vector_ops.Vec3Array(other.xx, other.yx, other.zx))
        c1 = self.apply_to_point(vector_ops.Vec3Array(other.xy, other.yy, other.zy))
        c2 = self.apply_to_point(vector_ops.Vec3Array(other.xz, other.yz, other.zz))
    ...
    def apply_to_point(self, point: vector_ops.Vec3Array) -> vector_ops.Vec3Array:
        """Applies Rot3Array to point."""
        return vector_ops.Vec3Array(
    ...
    def apply_inverse_to_point(self, point: vector_ops.Vec3Array) -> vector_ops.Vec3Array:
    ...
    def unsqueeze(self, dim: int) -> Rot3Array:
        ...
        return Rot3Array(
            *tensor_tree_map(
                ...
                [getattr(self, c) for c in field_names]
            )
        )
    ...
    def stop_gradient(self) -> Rot3Array:
        field_names = utils.get_field_names(Rot3Array)
        return Rot3Array(
            *[getattr(self, c).detach() for c in field_names]
        )
    ...
    def from_two_vectors(
        cls, 
        e0: vector_ops.Vec3Array,
        e1: vector_ops.Vec3Array
    ) -> Rot3Array:
        """Construct Rot3Array from two Vectors. Gram-Schmidt process
